    ...
    <tr>
        <td>
            ...
            <table width="610" align="center" style="font-size:15px; color:#5b5056">
                <tr><td height="40" valign="middle">Bonjour @if(!empty($sponsorship)){{ $sponsorship->first_name.' '.$sponsorship->last_name }}  @endif,</td></tr>
            </table>
            <table width="610" align="center" style="font-size:15px; color:#5b5056">
                <tr>
                    <td valign="middle" width="20" align="center">
                        {{ link_to($link, 'Inscription', array('id' => 'myButton', 'style' => 'background-color:#e64e66;color:#FFFFFF;display:inherit;width:108px;line-height: 2;vertical-align: middle;font-size: 15px;text-decoration: none')) }}
                    </td>
                </tr>
                <tr>
